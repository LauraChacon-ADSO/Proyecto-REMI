...
(1, 'DistryAseo', 'Cra 10 #20-30', '2025-06-15', 171000, '10123', AES_ENCRYPT('1011', 'claveID')),
(2, 'DistryAseo', 'Cra 10 #20-30', '2025-06-16', 135000, '10345', AES_ENCRYPT('1011', 'claveID')),
(3, 'DistryAseo', 'Cra 10 #20-30', '2025-06-17',  92000, '10234', AES_ENCRYPT('1012', 'claveID')),
(4, 'DistryAseo', 'Cra 10 #20-30', '2025-06-17',  45000, '10345', AES_ENCRYPT('1013', 'claveID')),
(5, 'DistryAseo', 'Cra 10 #20-30', '2025-06-18', 111000, '10456', AES_ENCRYPT('1012', 'claveID')),
(6, 'DistryAseo', 'Cra 10 #20-30', '2025-06-18',  78000, '10123', AES_ENCRYPT('1012', 'claveID')),
(7, 'DistryAseo', 'Cra 10 #20-30', '2025-06-19',  30000, '10230', AES_ENCRYPT('1011', 'claveID')),
(8, 'DistryAseo', 'Cra 10 #20-30', '2025-06-19',  54000, '10234', AES_ENCRYPT('1013', 'claveID')),
(9, 'DistryAseo', 'Cra 10 #20-30', '2025-06-20',  25000, '10345', AES_ENCRYPT('1013', 'claveID')),
(10, 'DistryAseo', 'Cra 10 #20-30', '2025-06-20',  83000, '10456', AES_ENCRYPT('1011', 'claveID')),
(11, 'DistryAseo', 'Cra 10 #20-30', '2025-06-17', 239000, '10123', AES_ENCRYPT('1012', 'claveID')),
(12, 'DistryAseo', 'Cra 10 #20-30', '2025-06-18', 292000, '10234', AES_ENCRYPT('1013', 'claveID')),
(13, 'DistryAseo', 'Cra 10 #20-30', '2025-06-19', 260000, '10345', AES_ENCRYPT('1012', 'claveID')),
(14, 'DistryAseo', 'Cra 10 #20-30', '2025-06-20', 315000, '10456', AES_ENCRYPT('1011', 'claveID')),
(15, 'DistryAseo', 'Cra 10 #20-30', '2025-06-21', 254000, '10123', AES_ENCRYPT('1012', 'claveID')),
(16, 'DistryAseo', 'Cra 10 #20-30', '2025-06-22', 289000, '10230', AES_ENCRYPT('1011', 'claveID')),
(17, 'DistryAseo', 'Cra 10 #20-30', '2025-06-23', 320000, '10456', AES_ENCRYPT('1011', 'claveID')),
(18, 'DistryAseo', 'Cra 10 #20-30', '2025-06-24', 246000, '10345', AES_ENCRYPT('1012', 'claveID')),
(19, 'DistryAseo', 'Cra 10 #20-30', '2025-06-25', 278000, '10234', AES_ENCRYPT('1012', 'claveID')),
(20, 'DistryAseo', 'Cra 10 #20-30', '2025-06-26', 301000, '10123', AES_ENCRYPT('1013', 'claveID'));
...
INSERT INTO Categorias (Id_categoria, nombreCat) VALUES
('T', 'Trapero'),
('E', 'Escoba'),
('C', 'Cepillo'),
('R', 'Recogedor'),
...
INSERT INTO Subcategorias (Id_subcategoria, nombreSub, Categoria) VALUES
('TB', 'Trapero blanco', 'T'),
('TC', 'Trapero color', 'T'),
('EB', 'Escoba blanca', 'E'),
('EC', 'Escoba color', 'E'),
('CP', 'Cepillo plano', 'C'),
('CM', 'Cepillo mano', 'C'),
('RCB', 'Recogedor con banda', 'R'),
('RSB', 'Recogedor sin banda', 'R'),
('PE', 'Recogedor con banda', 'P'),
('PR', 'Recogedor con banda', 'P');
...
('PEMCT011', 'Palo escoba madera con tapon', NULL, 18000, 'PE'),
('PEMST012', 'Palo escoba madera sin tapon', NULL, 17000, 'PE'),
('PRP013', 'Palo recogedor plastico',NULL, 12000, 'PR');

INSERT INTO Productos (cod_Producto, Referencia, marcaProducto, precioDocena, Subcategoria) VALUES
('EBSDS014','Escoba blanca super dana suave','RD',67000,'EB');
...
INSERT INTO Movimientos_stock (Id_movimiento, Tipo, Cantidad, Fecha, Observaciones, Stock, Proveedor) VALUES
(46, 'Entrada', 1, '2025-06-28', 'Reabastecimiento', 12, 'DistribucionesHogar');
